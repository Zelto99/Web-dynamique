...
if(isset($_POST['inscription']))
{
  ...
  $req1=$bdd->prepare("INSERT INTO auteur(prenom,nom,pseudo,mdp,mail,age,statut,adresse,ville,pays,code_postal) VALUES(?,?,?,?,?,?,?,?,?,?,?)");
  $req1->execute(array($prenom,$nom,$pseudo,$mdp,$mail,$age,$statut,$adresse,$ville,$pays,$code_postal));
          ...
          <div class="col-md-12 mb-3">
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input name="code_postal" type="number" class="form-control" id="code_postal" placeholder="" value="" required>
                <div class="invalid-feedback">
                  Code postal requis.
                </div>
              </div>
			...
			<div class="col-md-12 mt-3">	
		  		<button class="btn btn-primary btn-lg btn-block" type="submit" name="inscription">Confirmer l'inscription</button>
		  	</div>
